...
namespace Misc.CzechInvoiceGenerator.Areas.Admin.Controllers
{
    [AuthorizeAdmin]
    [Area("Admin")]
    [PermissionAuthorize(PermissionSystemName.PaymentMethods)]
    public class MiscCzechInvoiceGeneratorController : BasePluginController
    {
        ...
        public MiscCzechInvoiceGeneratorController(
        ...
        public async Task<IActionResult> Create(InvoiceSeriesModel model, bool continueEditing)
        {
            if (ModelState.IsValid)
            {
                ...
                Success(_translationService.GetResource("Misc.CzechInvoiceGenerator.Added"));
        ...
        public async Task<IActionResult> Edit(InvoiceSeriesModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Success(_translationService.GetResource("Misc.CzechInvoiceGenerator.Edited"));
